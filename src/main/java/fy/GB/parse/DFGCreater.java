...
//            }
             ...
             */
            EnclosedExpr enclosedExpr = expression.asEnclosedExpr();
            return analysisExprForVar(enclosedExpr.getInner());
             ...
             */
            FieldAccessExpr fieldAccessExpr = expression.asFieldAccessExpr();
            return analysisExprForVar(fieldAccessExpr.getScope());
        }
        Set<String> s1 = new HashSet<>();
    ...
    private Set<DFVarNode> intersection(Set<DFVarNode> in, String varName, GraphNode node) {
        ...
        in.removeIf(next -> next.getVarName().equals(varName));
    ...
    private Set<DFVarNode> copy(Set<DFVarNode> in) {
        Set<DFVarNode> result = new HashSet<>(in);
        return result;
    }
